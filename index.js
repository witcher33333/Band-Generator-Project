...
app.post("/submit", (req, res) => {
  ...
  var randAdj = Math.floor(adj.length * Math.random());
  
  var randNn = Math.floor(noun.length * Math.random());
  
  res.render("index.ejs" , { randomAdj : adj[randAdj] , randomNoun : noun[randNn] });
